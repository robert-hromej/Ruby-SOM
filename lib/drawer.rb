...
class Drawer
  ...
  def file_name
    ...
    "#{dir}/iteration_#{som.current_iteration}.png"
  end
  ...
  def save_to_file file_name
    draw.save file_name #, :interlace => true
  end
  ...
  def draw_neurons_hexagonal
    ...
    rows.times do |row|
      cols.times do |col|
        ...
        draw.polygon coordinates, stroke_color = ChunkyPNG::Color::BLACK, fill_color = Color::RGB.new(color, color, color).html
      end
    end
  end
